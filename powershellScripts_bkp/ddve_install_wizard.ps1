...
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] DDVE Authentication is successful" -ForegroundColor Green
}
catch{
...
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Successfully get the system id information" -ForegroundColor Green
}
catch{
...
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Successfully get the license information" -ForegroundColor Green
}
catch{
...
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Successfully created cradmin user " -ForegroundColor Green
}
catch{
...
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Successfully created secofficer1 user " -ForegroundColor Green
}
catch{
...
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] DDVE Authentication is successful using secofficer1 credentials " -ForegroundColor Green
}
catch{
...
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Successfully created ddve secofficer2 user " -ForegroundColor Green
}
catch{
...
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Successfully enabled ddve system passphrase " -ForegroundColor Green
}
catch{
...
$StatusCode = $_.Exception.Response.StatusCode
    $ErrorMessage = $_.ErrorDetails.Message
    Write-Error "$([int]$StatusCode) $($StatusCode) -$($ErrorMessage)"
    Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[ERROR] Failed to enable ddve system passphrase " -ForegroundColor Red
    exit 1
}
...
sleep -s 2
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Successfully enable ddve filesys encryption" -ForegroundColor Green
Invoke-SSHCommand -Index $sessionID.sessionid -Command $Command1 -ErrorAction SilentlyContinue
Sleep -s 2
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Successfully enable ddve filesys restart" -ForegroundColor Green
}
catch{
    ...
    $ErrorMessage = $_.ErrorDetails.Message
    Write-Error "$([int]$StatusCode) $($StatusCode) -$($ErrorMessage)"
    Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[ERROR] Failed to enable ddve filesys encryption" -ForegroundColor Red
    exit 1
}
...
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Successfully enabled ddve ddboost" -ForegroundColor Green
}
catch{
...
Invoke-SSHCommand -Index $sessionID.sessionid -Command $Command   # Invoke Command Over SSH
sleep -s 2
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Sucessfully enabled ddve user password aging" -ForegroundColor Green
Invoke-SSHCommand -Index $sessionID.sessionid -Command $Command1 -ErrorAction SilentlyContinue
Sleep -s 2
Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[INFO] Sucessfully enabled ddve enable ddve authroization policy" -ForegroundColor Green
}
catch{
    ...
    $ErrorMessage = $_.ErrorDetails.Message
    Write-Error "$([int]$StatusCode) $($StatusCode) -$($ErrorMessage)"
    Write-Log "E:\Workspace\UIAutomation\Log Files\DDVElog.txt" "[ERROR] Failed to enable ddve authroization policy and user password aging" -ForegroundColor Red
    exit 1
}
}
catch{
